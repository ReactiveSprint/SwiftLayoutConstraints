...
class GreaterThanSpec: QuickSpec {
    override func spec() {
        var view1: UIView!
        var view2: UIView!
        var parent: UIView!
        ...
        describe("GreaterThan two constraints") {
            ...
            it("should GreaterThan two lhs constraints") {
                constraint = lhs ~>= rhs
            }
            
            it("should GreaterThan with rhs constraints") {
        ...
        describe("GreaterThan constant") {
            it("should GreaterThan to a constant") {
        ...
        describe("GreaterThan array") {
            it("should GreaterThan view to array") {
